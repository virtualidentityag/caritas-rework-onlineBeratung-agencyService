...
public class TestConstants {
  ...
  public static final Map<Integer, ExtendedConsultingTypeResponseDTO>
  ...
  public static final Agency AGENCY_SUCHT =
      Agency.builder()
          .id(AGENCY_ID)
          .name(AGENCY_NAME)
  ...
  public static final AgencyTopic AGENCY_TOPIC =
      AgencyTopic.builder().topicId(TOPIC_ID).agency(AGENCY_SUCHT).build();

  public static final Agency AGENCY_SEARCH_WITH_TOPICS =
      Agency.builder()
          .id(AGENCY_ID)
          .name(AGENCY_NAME)
          .description(AGENCY_DESCRIPTION)
  ...
  public static final List<AgencyResponseDTO> AGENCY_RESPONSE_DTO_LIST =
      Collections.singletonList(AGENCY_RESPONSE_DTO);
  public static final FullAgencyResponseDTO FULL_AGENCY_RESPONSE_DTO =
      new FullAgencyResponseDTO()
          .id(AGENCY_ID)
          .name(AGENCY_NAME)
          .postcode(POSTCODE)
          .city(AGENCY_CITY)
  ...
  public static final List<FullAgencyResponseDTO> FULL_AGENCY_RESPONSE_DTO_LIST =
      Collections.singletonList(FULL_AGENCY_RESPONSE_DTO);
  ...
  public static final ExtendedConsultingTypeResponseDTO
      CONSULTING_TYPE_SETTINGS_WITH_WHITESPOT_AGENCY =
          ExtendedConsultingTypeResponseDTOHelper.createExtendedConsultingTypeResponseDTO(
              CONSULTING_TYPE_SUCHT, WHITESPOT_AGENCIES_SUCHT, REGISTRATION_SUCHT);
  public static final ExtendedConsultingTypeResponseDTO
      CONSULTING_TYPE_SETTINGS_WITHOUT_WHITESPOT_AGENCY =
          ExtendedConsultingTypeResponseDTOHelper.createExtendedConsultingTypeResponseDTO(
              CONSULTING_TYPE_U25, WHITESPOT_AGENCIES_U25, REGISTRATION_U25);
  ...
  public static final List<Agency> AGENCY_LIST_WITH_TOPICS =
      Collections.singletonList(AGENCY_SEARCH_WITH_TOPICS);
