...
class AgencyDataProtectionValidationServiceTest {
  ...
  @InjectMocks AgencyDataProtectionValidationService agencyDataProtectionValidator;
  ...
  private de.caritas.cob.agencyservice.tenantservice.generated.web.model.RestrictedTenantDTO
      tenantWithPrivacy(String privacy) {
  ...
  void validate_Should_NotValidate_When_DataResponsibleIsNotSet() {
    ...
    try {
      ...
      // then
      assertThat(e.getHttpStatusExceptionReason())
          .isEqualTo(HttpStatusExceptionReason.DATA_PROTECTION_RESPONSIBLE_IS_EMPTY);
    }
  }
  ...
  void validate_Should_NotValidate_When_AlternativeDataResponsibleIsNotSet() {
    ...
    try {
      ...
      // then
      assertThat(e.getHttpStatusExceptionReason())
          .isEqualTo(HttpStatusExceptionReason.DATA_PROTECTION_ALTERNATIVE_RESPONSIBLE_IS_EMPTY);
    }
  }
