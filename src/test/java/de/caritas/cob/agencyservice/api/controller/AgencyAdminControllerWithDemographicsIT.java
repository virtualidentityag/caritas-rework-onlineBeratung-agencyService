...
class AgencyAdminControllerWithDemographicsIT {
  ...
  void createAgency_Should_returnStatusCreated_When_calledWithValidCreateParamsAndValidAuthority()
        ...
        new AgencyDTO()
            ...
            .demographics(
                new DemographicsDTO()
                    ...
                    .ageTo(20)
                    .genders(
                        List.of(Gender.MALE.name(), Gender.FEMALE.name(), Gender.DIVERSE.name())));
    ...
    mockMvc
        ...
        .andExpect(
            jsonPath("_embedded.demographics.genders")
                .value(contains("MALE", "FEMALE", "DIVERSE")));
  }
  ...
  void updateAgency_Should_returnStatusOk_When_calledWithValidCreateParamsAndValidAuthority()
    ...
    mockMvc
        ...
        .andExpect(jsonPath("_embedded.demographics.genders").value(contains("NOT_PROVIDED")));
  }

  @Test
  @WithMockUser(authorities = {"AUTHORIZATION_AGENCY_ADMIN"})
  void
      updateAgency_Should_returnStatusBadRequest_When_calledWithMissingDemographicsDataAndDemographicsFeatureIsOn()
          throws Exception {
    // given
    var extendedConsultingTypeResponseDTO = new ExtendedConsultingTypeResponseDTO();
    when(consultingTypeManager.getConsultingTypeSettings(anyInt()))
