...
class AgencyAdminSearchTenantSupportServiceTest {
  ...
  @Autowired private AgencyAdminSearchTenantSupportService agencyAdminSearchTenantSupportService;
  ...
  @Mock private UserAdminApiClient userAdminApiClient;
  ...
  void searchAgency_Should_FindAllAgenciesForGivenTenant() {
    ...
    var agencySearchResult =
        agencyAdminSearchTenantSupportService.searchAgencies("", 1, 10, new Sort());
    ...
    assertThat(agencySearchResult.getEmbedded())
        .isNotEmpty()
        .hasSize(2)
        .extracting("embedded.id")
        .containsOnly(1735L, 1737L);
  }
  ...
  void searchAgency_Should_FindAllAgenciesForAllTenants_When_UserIsSuperAdmin() {
    ...
    assertThat(agencySearchResult.getEmbedded())
        ...
        .hasSize(3)
        .extracting("embedded.id")
        .contains(1735L, 1737L, 1738L);
  }

  @Test
  void
      searchAgency_Should_FindOnlyAgenciesManagedByTheAdminAndInTheTenant_When_UserIsAgencyAdmin() {
    // given
  ...
  private AdminAgencyResponseDTO getAdminAgencies(Long... agencyIds) {
    AdminAgencyResponseDTO adminAgencyResponseDTO =
        new de.caritas.cob.agencyservice.useradminservice.generated.web.model
