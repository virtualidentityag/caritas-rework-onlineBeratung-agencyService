...
public class RoleAuthorizationAuthorityMapperTest {
  ...
  @Test
  public void
      mapAuthorities_Should_returnGrantedAgencyAdminAuthority_When_authorityIsAgencyAdmin() {
    List<GrantedAuthority> grantedAuthorities =
        Stream.of("agency-admin").map(SimpleGrantedAuthority::new).collect(Collectors.toList());
  ...
  @Test
  public void
      mapAuthorities_Should_returnGrantedAgencyAdminAuthority_When_authoritiesContainsAgencyAdmin() {
    List<GrantedAuthority> grantedAuthorities =
        Stream.of("a", "v", "agency-admin", "c")
  ...
  @Test
  public void
      mapAuthorities_Should_returnGrantedAgencySearchAuthority_When_authoritiesRestrictedConsultantAdmin() {
    List<GrantedAuthority> grantedAuthorities =
        Stream.of("a", "v", "restricted-consultant-admin", "c")
            .map(SimpleGrantedAuthority::new)
            .collect(Collectors.toList());
    ...
    assertThat(mappedAuthorities.iterator().next().getAuthority())
        .isEqualTo(AuthorityValue.SEARCH_AGENCIES);
  }
