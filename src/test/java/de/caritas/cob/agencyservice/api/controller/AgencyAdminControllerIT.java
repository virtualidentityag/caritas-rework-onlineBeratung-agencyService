...
class AgencyAdminControllerIT {
  ...
  @WithMockUser(authorities = {"AUTHORIZATION_AGENCY_ADMIN"})
  void
      createAgency_Should_returnStatusCreated_And_setTenantIdFromRequest_When_calledWithValidCreateParamsAndAgencySuperAdminAuthority()
          throws Exception {
    // given
  ...
  @WithMockUser(authorities = "AUTHORIZATION_AGENCY_ADMIN")
  void
      updateAgency_Should_returnStatusOk_When_CentralDataProtectionIsEnabled_And_PayloadContainsValidDataProtectionContent()
          throws Exception {
    var response = new ExtendedConsultingTypeResponseDTO();
            ...
            .dataProtection(
                new DataProtectionDTO()
                    .dataProtectionResponsibleEntity(
                        DataProtectionDTO.DataProtectionResponsibleEntityEnum
                            .DATA_PROTECTION_OFFICER)
                    .dataProtectionOfficerContact(
                        new DataProtectionContactDTO()
                            .nameAndLegalForm("data protection contact")
                            .city("Munich")
                            .postcode("00001")
                            .phoneNumber("321-321-321")
                            .email("dataprotection@onlineberatung.net")));
  ...
  @WithMockUser(authorities = "AUTHORIZATION_AGENCY_ADMIN")
  void
      updateAgency_Should_returnStatusBadRequest_When_CentralDataProtectionIsEnabled_And_PayloadContainsInvalidDataProtectionContent()
          throws Exception {
    var response = new ExtendedConsultingTypeResponseDTO();
  ...
  @Test
  @WithMockUser(authorities = "AUTHORIZATION_AGENCY_ADMIN")
  void updateAgency_Should_persistDataProtectionAttributes_When_payloadContainsDataProtection()
      throws Exception {
    var response = new ExtendedConsultingTypeResponseDTO();
    when(consultingTypeManager.getConsultingTypeSettings(anyInt())).thenReturn(response);
            ...
            .dataProtection(
                new DataProtectionDTO()
                    ...
                    .agencyDataProtectionResponsibleContact(
                        new DataProtectionContactDTO()
                            .nameAndLegalForm("agency responsible contact")
                            .city("Freiburg")
                            .postcode("99999")
                            .phoneNumber("123-123-123")
                            .email("agency@onlineberatung.net"))
                    .dataProtectionOfficerContact(
                        new DataProtectionContactDTO()
                            .nameAndLegalForm("data protection contact")
                            .city("Munich")
    ...
    mockMvc
        ...
        .andExpect(jsonPath("_embedded.deleteDate").exists())
        .andExpect(
            jsonPath("_embedded.dataProtection.dataProtectionResponsibleEntity")
                .value("AGENCY_RESPONSIBLE"))
        .andExpect(
            jsonPath(
                    "_embedded.dataProtection.agencyDataProtectionResponsibleContact.nameAndLegalForm")
                .value("agency responsible contact"))
        .andExpect(
            jsonPath("_embedded.dataProtection.agencyDataProtectionResponsibleContact.city")
                .value("Freiburg"))
        .andExpect(
            jsonPath("_embedded.dataProtection.agencyDataProtectionResponsibleContact.postcode")
                .value("99999"))
        .andExpect(
            jsonPath("_embedded.dataProtection.agencyDataProtectionResponsibleContact.phoneNumber")
                .value("123-123-123"))
        .andExpect(
            jsonPath("_embedded.dataProtection.agencyDataProtectionResponsibleContact.email")
                .value("agency@onlineberatung.net"))
        .andExpect(
            jsonPath("_embedded.dataProtection.dataProtectionOfficerContact.nameAndLegalForm")
                .value("data protection contact"))
        .andExpect(
            jsonPath("_embedded.dataProtection.dataProtectionOfficerContact.city").value("Munich"))
        .andExpect(
            jsonPath("_embedded.dataProtection.dataProtectionOfficerContact.postcode")
                .value("00001"))
        .andExpect(
            jsonPath("_embedded.dataProtection.dataProtectionOfficerContact.phoneNumber")
                .value("321-321-321"))
        .andExpect(
            jsonPath("_embedded.dataProtection.dataProtectionOfficerContact.email")
                .value("dataprotection@onlineberatung.net"));
  ...
  @WithMockUser(authorities = {"AUTHORIZATION_RESTRICTED_AGENCY_ADMIN"})
  void
      updateAgency_Should_returnStatusOk_When_calledWithRestrictedAgencyAdminThatHasPermissionForGivenAgency()
          throws Exception {
    // given
    var extendedConsultingTypeResponseDTO = new ExtendedConsultingTypeResponseDTO();
    when(consultingTypeManager.getConsultingTypeSettings(anyInt()))
  ...
  @WithMockUser(authorities = {"AUTHORIZATION_RESTRICTED_AGENCY_ADMIN"})
  void
      updateAgency_Should_returnAccessDenied_When_calledWithRestrictedAgencyAdminDoesntHavePermissionForGivenAgency()
          throws Exception {
    // given
    var extendedConsultingTypeResponseDTO = new ExtendedConsultingTypeResponseDTO();
    when(consultingTypeManager.getConsultingTypeSettings(anyInt()))
  ...
  @Test
  void getAgency_Should_returnUnauthorized_When_calledAsUnauthenticatedUser() throws Exception {
    mockMvc
        .perform(get(PATH_GET_AGENCY_BY_ID).accept(MediaType.APPLICATION_JSON))
  ...
  @Test
  void createAgency_Should_returnUnauthorized_When_calledAsUnauthenticatedUser() throws Exception {
    EasyRandom easyRandom = new EasyRandom();
    AgencyDTO agencyDTO = easyRandom.nextObject(AgencyDTO.class);
    String payload = JsonConverter.convertToJson(agencyDTO);
    mockMvc
        .perform(
            post(PathConstants.CREATE_AGENCY_PATH).content(payload).contentType(APPLICATION_JSON))
        .andExpect(status().isUnauthorized());
  }

  @Test
  void updateAgency_Should_returnUnauthorized_When_calledAsUnauthenticatedUser() throws Exception {
    EasyRandom easyRandom = new EasyRandom();
  ...
  void getAgency_Should_returnIsForbidden_When_calledAsUnauthorizedUser() throws Exception {
    mockMvc
        .perform(get(PATH_GET_AGENCY_BY_ID).accept(MediaType.APPLICATION_JSON))
        .andExpect(status().isForbidden());
  }
  ...
  @Test
  @WithMockUser(authorities = {"NOT_AUTHORIZED"})
  void createAgency_Should_returnForbidden_When_calledAsUnauthorizedUser() throws Exception {
    EasyRandom easyRandom = new EasyRandom();
    AgencyDTO agencyDTO = easyRandom.nextObject(AgencyDTO.class);
    String payload = JsonConverter.convertToJson(agencyDTO);
    mockMvc
  ...
  @Test
  @WithMockUser(authorities = {"NOT_AUTHORIZED"})
  void updateAgency_Should_returnForbidden_When_calledAsUnauthorizedUser() throws Exception {
    EasyRandom easyRandom = new EasyRandom();
    UpdateAgencyDTO agencyDTO = easyRandom.nextObject(UpdateAgencyDTO.class);
    String payload = JsonConverter.convertToJson(agencyDTO);
    mockMvc
  ...
  @Test
  @WithMockUser(authorities = {"NOT_AUTHORIZED"})
  void getAgencyByTenantId_Should_returnForbidden_When_calledAsUnauthorizedUser() throws Exception {
    mockMvc
        .perform(get(PATH_GET_AGENCY_BY_TENANT_ID).accept(MediaType.APPLICATION_JSON))
        .andExpect(status().isForbidden());
  }
  ...
  void
      getAgencyByTenantId_Should_returnForbidden_When_calledAsTenantAdminButWithoutAgencyPriviliges()
          throws Exception {
    mockMvc
        .perform(get(PATH_GET_AGENCY_BY_TENANT_ID).accept(MediaType.APPLICATION_JSON))
        .andExpect(status().isForbidden());
  ...
  @WithMockUser(authorities = {"AUTHORIZATION_AGENCY_ADMIN"})
  void
      getAgencyByTenantId_Should_returnForbidden_When_calledAsAgencyAdminButWithoutSuperAdminPriviliges()
          throws Exception {
    mockMvc
        .perform(get(PATH_GET_AGENCY_BY_TENANT_ID).accept(MediaType.APPLICATION_JSON))
        .andExpect(status().isForbidden());
