...
class MultitenancyWithSingleDomainTenantResolverTest {
  ...
  @InjectMocks MultitenancyWithSingleDomainTenantResolver resolver;

  @Mock HttpServletRequest request;

  @Mock TenantControllerApi tenantControllerApi;
  ...
  @Mock TenantServiceApiControllerFactory tenantServiceApiControllerFactory;
  ...
  @Test
  void
      resolve_Should_resolveToTenantIdBasedOnMainTenantSubdomainValue_When_ApplicationSettingsFound() {
    // given
    setMultitenancyWithSingleDomain(true);
