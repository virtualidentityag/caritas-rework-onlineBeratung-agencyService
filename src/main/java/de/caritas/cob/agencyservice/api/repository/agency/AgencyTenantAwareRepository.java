...
public interface AgencyTenantAwareRepository extends JpaRepository<Agency, Long>, AgencyRepository {
   ...
   */
  @Query(
      value = SELECT_WITHOUT_TOPICS + AND_A_TENANT_ID_FILTER + GROUP_BY_ORDER_BY,
      nativeQuery = true)
  ...
  @Query(
      value = SELECT_WITH_TOPICS + AND_A_TENANT_ID_FILTER + GROUP_BY_ORDER_BY,
      nativeQuery = true)
  ...
  @Query(
      value = SELECT_ALL_AGENCIES_TOPICS + AND_A_TENANT_ID_FILTER + ORDER_BY_TOPIC,
      nativeQuery = true)
